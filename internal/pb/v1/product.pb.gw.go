...
func RegisterProductServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProductServiceServer) error {
	...
	mux.Handle("POST", pattern_ProductService_CreateProduct_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/com.ecommerce.api.v1.ProductService/CreateProduct", runtime.WithHTTPPathPattern("/api/v1/products"))
		if err != nil {
		...
		forward_ProductService_CreateProduct_0(annotatedContext, mux, outboundMarshaler, w, req, response_ProductService_CreateProduct_0{resp.(*CreateProductResponse)}, mux.GetForwardResponseOptions()...)
...
func RegisterProductServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProductServiceClient) error {
	...
	mux.Handle("POST", pattern_ProductService_CreateProduct_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/com.ecommerce.api.v1.ProductService/CreateProduct", runtime.WithHTTPPathPattern("/api/v1/products"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
type response_ProductService_CreateProduct_0 struct {
	*CreateProductResponse
}

func (m response_ProductService_CreateProduct_0) XXX_ResponseBody() interface{} {
	return m.Product
}
